        ...
        <Dialog open={dialogOpen} onOpenChange={(o) => { if (!o) closeDialog(); else setDialogOpen(true); }}>
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label>Imagem</Label>
                {form.image_url && <img src={form.image_url} alt="" className="w-full aspect-[21/9] object-cover rounded-md mb-2" />}
      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            <TableRow key={b.id}>
              <TableCell>
                {b.image_url ? <img src={b.image_url} className="h-10 w-20 rounded object-cover" /> : <ImageIcon className="h-10 w-10 text-muted-foreground" />}
              </TableCell>
