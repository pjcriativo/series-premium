...
import { LayoutDashboard, Film, Tv, Users, LogOut, Coins, FolderTree, Menu, Image, UserCircle, Globe, Heart } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/fan-club", icon: Heart, label: "Fan Club" },
