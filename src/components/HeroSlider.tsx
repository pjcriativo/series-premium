  ...
  ({ banners }, ref) => {
    ...
    return (
      <div ref={ref} className="w-full px-4 md:px-8 pt-4">
        <section className="relative overflow-hidden max-w-[2100px] mx-auto rounded-lg">
          ...
          <div className="absolute top-0 inset-x-0 h-32 md:h-40 bg-gradient-to-b from-black/50 to-transparent z-10 pointer-events-none" />
