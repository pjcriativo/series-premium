  ...
  return (
    <div className="w-full px-4 md:px-8 pt-4">
      <section className="relative max-w-7xl mx-auto overflow-hidden rounded-lg">
        {/* Fade superior */}
        <div className="absolute top-0 inset-x-0 h-20 md:h-32 bg-gradient-to-b from-background to-transparent z-10 pointer-events-none" />
        {/* Fade inferior */}
        <div className="absolute bottom-0 inset-x-0 h-20 md:h-32 bg-gradient-to-t from-background to-transparent z-10 pointer-events-none" />
